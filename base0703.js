...
var navStr = `
    ...
    <ul class="layui-nav" id="nav">
        ...
        <li class="layui-nav-item">
          ...
          <dl class="layui-nav-child">
            <dd><a href="partner.html?role=5">所有</a></dd?
            <dd><a href="partner.html?role=6">开发</a></dd>
            <dd><a href="partner.html?role=7">产品</a></dd>
            <dd><a href="partner.html?role=8">设计</a></dd>
            <dd><a href="partner.html?role=9">运营</a></dd>
          </dl>
        </li>
    </ul>
    `;
